...
object PairingCheck {
  ...
  /** Pairing function is defined as: `e: G_1 x G_2 -> G_T` where G1 is element of [[com.chipprbots.ethereum.crypto.zksnark.BN128.BN128G1]]
    * and G2 is element of [[com.chipprbots.ethereum.crypto.zksnark.BN128.BN128G2]]
    *
