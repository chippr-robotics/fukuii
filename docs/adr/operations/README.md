...
This directory contains Architecture Decision Records related to operational features, administration, monitoring, user interfaces, and deployment.

## Naming Convention

Operations ADRs use the format: `OPS-NNN-title.md` where NNN is a zero-padded sequential number.
