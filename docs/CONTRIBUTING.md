...
For the fastest setup, use GitHub Codespaces which provides a pre-configured development environment. See [.devcontainer/README.md](https://github.com/chippr-robotics/fukuii/blob/develop/.devcontainer/README.md) for details.
...
See [.github/workflows/README.md](https://github.com/chippr-robotics/fukuii/blob/develop/.github/workflows/README.md) for detailed release process documentation.
...
- [GitHub Workflow Documentation](https://github.com/chippr-robotics/fukuii/blob/develop/.github/workflows/README.md)
- [Quick Start Guide](https://github.com/chippr-robotics/fukuii/blob/develop/.github/QUICKSTART.md)
- [Branch Protection Setup](https://github.com/chippr-robotics/fukuii/blob/develop/.github/BRANCH_PROTECTION.md)
- [Architectural Decision Records](adr/README.md)
- [Migration History](historical/MIGRATION_HISTORY.md)
- [Static Analysis Inventory](reports/STATIC_ANALYSIS_INVENTORY.md)
