...
<div class="wizard-container">
  ...
  <div class="wizard-tabs" role="tablist">
    <button class="wizard-tab active" data-tab="models" role="tab" aria-selected="true" aria-controls="models" id="tab-models">Models</button>
    <button class="wizard-tab" data-tab="chains" role="tab" aria-selected="false" aria-controls="chains" id="tab-chains">Chains</button>
    <button class="wizard-tab" data-tab="custom" role="tab" aria-selected="false" aria-controls="custom" id="tab-custom">Custom Tuning</button>
    <button class="wizard-tab" data-tab="upload" role="tab" aria-selected="false" aria-controls="upload" id="tab-upload">Upload / Download</button>
  </div>

  <!-- Models Tab -->
  <div id="models" class="wizard-content active" role="tabpanel" aria-labelledby="tab-models">
  ...
  <!-- Chains Tab -->
  <div id="chains" class="wizard-content" role="tabpanel" aria-labelledby="tab-chains">
    <div class="wizard-card">
  ...
  <!-- Custom Tuning Tab -->
  <div id="custom" class="wizard-content" role="tabpanel" aria-labelledby="tab-custom">
    <div class="wizard-card">
  ...
  <!-- Upload/Download Tab -->
  <div id="upload" class="wizard-content" role="tabpanel" aria-labelledby="tab-upload">
    <div class="wizard-card">
      ...
      <div id="upload-area" class="upload-area">
        ...
        <input type="file" id="file-input" accept=".conf" aria-label="Upload configuration file">
      </div>
