#!/bin/bash
# Quick start script for Run 003 configuration
# Fukuii node on ETC mainnet with debug sync/snap logging

set -e

echo "==================================================================="
echo "  Fukuii Run 003 - ETC Mainnet with Debug Sync/Snap Logging"
echo "==================================================================="
echo ""
...
case "$ACTION" in
    up|start)
        echo "Starting Fukuii Run 003..."
        echo ""
        $COMPOSE_CMD up -d
        echo ""
        echo "✓ Fukuii Run 003 started successfully!"
        echo ""
    ...
    down|stop)
        echo "Stopping Fukuii Run 003..."
        $COMPOSE_CMD down
        echo "✓ Fukuii Run 003 stopped."
        ;;
    
    restart)
        echo "Restarting Fukuii Run 003..."
        $COMPOSE_CMD restart
        echo "✓ Fukuii Run 003 restarted."
        ;;
    ...
    status)
        echo "Checking Fukuii Run 003 status..."
        echo ""
        $COMPOSE_CMD ps
        echo ""
