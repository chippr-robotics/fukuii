...
class ExecutionSpecsStateTestsSpec extends EthereumTestsSpec {
  ...
  "Execution Specs State Tests" - {

    "Basic Arithmetic Operations" - {

      "should pass basic ADD operation (add11)" taggedAs (
        IntegrationTest,
        EthereumTest,
        StateTest,
        SlowTest
    ...
    "Account State Transitions" - {
      ...
      "should handle non-constant addition (addNonConst)" taggedAs (
        IntegrationTest,
        EthereumTest,
        StateTest,
        SlowTest
    ...
    "State Root Validation" - {
      ...
      "should maintain correct state roots across transactions" taggedAs (
        IntegrationTest,
        EthereumTest,
        StateTest,
        SlowTest
    ...
    "Contract Execution" - {
      ...
      "should execute contract code correctly" taggedAs (
        IntegrationTest,
        EthereumTest,
        StateTest,
        SlowTest
    ...
    "Fork Compatibility" - {
      ...
      "should handle fork-specific state transitions" taggedAs (
        IntegrationTest,
        EthereumTest,
        StateTest,
        SlowTest
    ...
    "Account Balance and Nonce" - {
      ...
      "should correctly update account balances and nonces" taggedAs (
        IntegrationTest,
        EthereumTest,
        StateTest,
        SlowTest
    ...
    "Gas Calculations" - {
      ...
      "should compute gas costs correctly per execution specs" taggedAs (
        IntegrationTest,
        EthereumTest,
        StateTest,
        SlowTest
    ...
    "Storage Operations" - {
      ...
      "should handle storage operations correctly" taggedAs (
        IntegrationTest,
        EthereumTest,
        StateTest,
        SlowTest
    ...
    "Pre-compiled Contracts" - {
      ...
      "should execute pre-compiled contracts per specs" taggedAs (
        IntegrationTest,
        EthereumTest,
        StateTest,
        SlowTest
    ...
    "Complete State Validation" - {
      ...
      "should validate complete state across all test cases" taggedAs (
        IntegrationTest,
        EthereumTest,
        StateTest,
        ComprehensiveTest,
