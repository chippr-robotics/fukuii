...
abstract class CommonFakePeer(peerName: String, fakePeerCustomConfig: FakePeerCustomConfig)
  ...
  sealed trait LocalPruningConfigBuilder extends PruningConfigBuilder with com.chipprbots.ethereum.TestInstanceConfigProvider {
  ...
  lazy val storagesInstance: RocksDbDataSourceComponent with LocalPruningConfigBuilder with Storages.DefaultStorages =
    new RocksDbDataSourceComponent with LocalPruningConfigBuilder with Storages.DefaultStorages with com.chipprbots.ethereum.TestInstanceConfigProvider {
