...
/** Reports JVM and OS environment at node startup.
  *
  * Besu reference: BesuCommand.java ConfigurationOverviewBuilder — host section, lines 1488-1548.
  * Logs: Java version + VM name, max heap in MB, available CPU cores, OS name and architecture.
  */
