...
object Secp256r1 {
  ...
  /** Verify a P-256 ECDSA signature.
    ...
    * @param r     32-byte r component of signature
    * @param s     32-byte s component of signature
    * @param x     32-byte x coordinate of public key
    * @param y     32-byte y coordinate of public key
