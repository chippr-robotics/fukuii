...
/** ETH/68 wire protocol packet definitions.
  ...
  * 0x10  (0x00)  Status                       ETHPackets.Status68 (6-field, TD present)  unchanged (ETH64.Status deleted)
  * 0x11  (0x01)  NewBlockHashes               ETHPackets.NewBlockHashes                  unchanged (ETH62.NewBlockHashes deleted)
  * 0x12  (0x02)  Transactions                 ETHPackets.SignedTransactions               unchanged
  * 0x13  (0x03)  GetBlockHeaders              ETHPackets.GetBlockHeaders                  unchanged (ETH66 deleted)
  * 0x14  (0x04)  BlockHeaders                 ETHPackets.BlockHeaders                     unchanged (ETH66 deleted)
  * 0x15  (0x05)  GetBlockBodies               ETHPackets.GetBlockBodies                   unchanged (ETH66 deleted)
  * 0x16  (0x06)  BlockBodies                  ETHPackets.BlockBodies                      unchanged (ETH66 deleted)
  * 0x17  (0x07)  NewBlock                     ETHPackets.NewBlock                         unchanged
  * 0x18  (0x08)  NewPooledTransactionHashes   ETHPackets.NewPooledTransactionHashes       unchanged (ETH67 deleted)
  * 0x19  (0x09)  GetPooledTransactions        ETHPackets.GetPooledTransactions            unchanged (ETH66 deleted)
  * 0x1a  (0x0a)  PooledTransactions           ETHPackets.PooledTransactions               unchanged (ETH66 deleted)
  * 0x1d  (0x0d)  GetNodeData                  REJECTED — EIP-4938                        REMOVED in ETH68
  * 0x1e  (0x0e)  NodeData                     REJECTED — EIP-4938                        REMOVED in ETH68
  * 0x1f  (0x0f)  GetReceipts                  ETHPackets.GetReceipts                     unchanged (ETH66 deleted)
  * 0x20  (0x10)  Receipts                     ETHPackets.Receipts68 (bloom-inclusive)    unchanged (ETH66 deleted)
  *
