...
/** ETH68 protocol - removes GetNodeData and NodeData messages
  * See https://github.com/ethereum/devp2p/blob/master/caps/eth.md#eth68
  *
  * The main change in ETH68 is the removal of GetNodeData (0x0d) and NodeData (0x0e) messages.
  * These were used for state synchronization but have been deprecated in favor of snap sync.
  *
