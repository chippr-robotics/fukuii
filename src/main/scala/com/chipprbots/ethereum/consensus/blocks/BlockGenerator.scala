...
trait BlockGenerator {
  ...
  /** The type of consensus-specific data used in the block generation process.
    * For example, under [[com.chipprbots.ethereum.consensus.pow.PoWMining EthashConsensus]],
    * this represents the [[com.chipprbots.ethereum.domain.BlockBody#uncleNodesList ommers]].
    */
  type X
