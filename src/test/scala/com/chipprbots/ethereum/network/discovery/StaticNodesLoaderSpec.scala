...
class StaticNodesLoaderSpec extends AnyFlatSpec with Matchers {
  ...
  "StaticNodesLoader" should "load valid static nodes from a JSON file" in {
    ...
    try {
      ...
      nodes should contain("enode://6eecbdcc74c0b672ce505b9c639c3ef2e8ee8cddd8447ca7ab82c65041932db64a9cd4d7e723ba180b0c3d88d1f0b2913fda48972cdd6742fea59f900af084af@192.168.1.1:9076")
      nodes should contain("enode://a335a7e86eab05929266de232bec201a49fdcfc1115e8f8b861656e8afb3a6e5d3ffd172d153ae6c080401a56e3d620db2ac0695038a19e9b0c5220212651493@192.168.1.2:9076")
    } finally {
