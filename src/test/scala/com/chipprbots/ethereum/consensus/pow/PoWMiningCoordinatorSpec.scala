...
class PoWMiningCoordinatorSpec
  ...
  "PoWMinerCoordinator actor" - {
    ...
    "in Recurrent Mining" - {
      ...
      "Miners mine recurrently" taggedAs (UnitTest, ConsensusTest, FlakyTest) in new TestSetup {
      ...
      "StopMining stops PoWMinerCoordinator" taggedAs (UnitTest, ConsensusTest, FlakyTest) in new TestSetup {
