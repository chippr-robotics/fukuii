...
/** EIP-7935: Verify gas limit convergence behavior for the Olympia hard fork.
  *
  * Post-Olympia, the target gas limit increases from 8M to 60M. These tests verify that
  * calculateGasLimit() correctly converges toward the new target, matching core-geth's
...
class OlympiaGasLimitSpec extends AnyFlatSpec with Matchers {
  ...
  "Olympia gas limit (EIP-7935)" should "converge from pre-Olympia 8M to 60M target" taggedAs (OlympiaTest, ConsensusTest) in {
