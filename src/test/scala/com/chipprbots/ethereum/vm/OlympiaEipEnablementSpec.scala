...
/** Tests for Olympia EIP enablement flags and constants.
  *
  * Verifies that all 14 Olympia EIPs are correctly gated by fork block number and that
  * critical constants (EIP-2935 system contract address, history window) are correct.
  */
