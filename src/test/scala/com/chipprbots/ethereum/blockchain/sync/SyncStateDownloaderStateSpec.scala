...
class SyncStateDownloaderStateSpec
  ...
  it should "assign request to peers from already scheduled nodes to a max capacity" taggedAs(UnitTest, SyncTest) in new TestSetup {
  ...
  it should "favour already existing requests when assigning tasks with new requests" taggedAs(UnitTest, SyncTest) in new TestSetup {
    val perPeerCapacity = 20
  ...
  it should "handle response where part of data is malformed (bad hashes)" taggedAs(UnitTest, SyncTest) in new TestSetup {
    val perPeerCapacity = 20
  ...
  it should "handle response when there are spaces between delivered values" taggedAs(UnitTest, SyncTest) in new TestSetup {
