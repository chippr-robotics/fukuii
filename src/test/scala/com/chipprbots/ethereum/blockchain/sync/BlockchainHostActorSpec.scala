...
class BlockchainHostActorSpec extends AnyFlatSpec with Matchers {
  ...
  it should "return block headers by block number when response is shorter then what was requested" taggedAs(UnitTest, SyncTest) in new TestSetup {
    // given
    val firstHeader: BlockHeader = baseBlockHeader.copy(number = 3)
    val secondHeader: BlockHeader = baseBlockHeader.copy(number = 4)
  ...
  it should "return block headers in reverse when there are skipped blocks" taggedAs(UnitTest, SyncTest) in new TestSetup {
    // given
    val firstHeader: BlockHeader = baseBlockHeader.copy(number = 3)
  ...
  it should "return block headers in reverse when there are skipped blocks and we are asking for blocks before genesis" taggedAs(UnitTest, SyncTest) in new TestSetup {
    // given
    val firstHeader: BlockHeader = baseBlockHeader.copy(number = 3)
    val secondHeader: BlockHeader = baseBlockHeader.copy(number = 1)
  ...
  it should "return block headers in reverse when there are skipped blocks ending at genesis" taggedAs(UnitTest, SyncTest) in new TestSetup {
    // given
